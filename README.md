...
5. **warranty**: Contains information about warranty claims.
   ...
   - `repair_status`: Status of the warranty claim (e.g., Rejected,Pending,In progess,Completed).
...
## Conclusion
Through this project, I strengthened my SQL skills by working with millions of retail sales records in a real-world business context. I learned how to write and optimise complex queries, analyse large datasets efficiently, and extract meaningful insights to support data-driven decision-making. This experience enhanced my problem-solving and analytical abilities while demonstrating my capability to handle practical business scenarios using SQL. The project also serves as a valuable addition to my portfolio, showcasing my proficiency in data analysis and database querying.
---
